...
# root_dir<-FALSE;knitr::knit("inst/vignette_raw.Rmd", output = "vignettes/vignette.Rmd")
# root_dir<-TRUE;knitr::knit("inst/vignette_raw.Rmd", output = "README.md")
...
```{r, include=FALSE}
if(root_dir){
  making_altrep <- "vignettes/Making altrep.png"
  data_request <- "vignettes/data request.png"
}else{
  making_altrep <- "Making altrep.png"
  data_request <- "data request.png"
}
```
